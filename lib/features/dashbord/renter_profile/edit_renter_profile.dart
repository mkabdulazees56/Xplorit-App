...
class EditRenterProfile extends StatefulWidget {
  EditRenterProfile({super.key});

  @override
  State<EditRenterProfile> createState() => _EditRenterProfileState();
}

class _EditRenterProfileState extends State<EditRenterProfile> {
      ...
      for (RenterModel renter in renterController.rentersData) {
        if (renter.contactNumber == user?.phoneNumber) {
          try {
            ...
            existingProfilePictureUrl = TImages.profile;
  ...
  void updateRenterData(
    ...
    renterController.updateRenterData(documentId, renter);
  }
...
// class EditRenterProfile extends StatefulWidget {
//   EditRenterProfile({this.mode = '', super.key});
...
//                   child: IconButton(
//                     onPressed: () {
//                       Get.to(() => EditRenterProfile(mode: 'edit'));
//                     },
