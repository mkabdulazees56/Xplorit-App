...
class MyGaragePageNotActive extends StatefulWidget {
  const MyGaragePageNotActive({
  ...
  @override
  State<MyGaragePageNotActive> createState() => _MyGaragePageNotActiveState();
}

class _MyGaragePageNotActiveState extends State<MyGaragePageNotActive> {
  bool isSwitched = false;
  String switchText = 'Activate';
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'By activating this vehicle will \n be removed from listing',
                                          style: Theme.of(context)
                                              .textTheme
                                              .headlineSmall,
                                        ),
