...
class GarageAddress extends StatefulWidget {
  GarageAddress({
    super.key,
  });

  @override
  State<GarageAddress> createState() => _GarageAddressState();
}

class _GarageAddressState extends State<GarageAddress> {
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      Get.to(() =>
                          EditGarageAddress(garageAddress: _currentAddress));
                    },
                    color: TColors.primary,
                    icon: Icon(
                      Icons.edit,
